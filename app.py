...
if len(players) == 5:
   ...
   """
    ...
    unsafe_allow_html=True
        ...
        st.warning(f"This group of players did not play together this season, hence there is no data available. Please select a different group. Possible lineup: {possible_lineup}")
else:
